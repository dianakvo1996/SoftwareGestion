...
for ($i = 0; $i < count($datos); $i++) {
   $objeto=$datos[$i];
    ...
    $lista.="<td><a href='principal.php?CONTENIDO=calidad/otro/menuProceso.php&ideProceso={$ideProceso}&CONTENIDOINTERNO=calidad/otro/{$visualizador}&ruta=/{$carpeta}/Guias/{$objeto->getRuta()}'><img src='../presentacion/iconos/pdf.png'height='50px' title='PDF'></a></td>";
    $lista.='</tr>';
}

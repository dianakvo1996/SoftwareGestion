...
for ($i = 0; $i < count($datos); $i++) {
   $objeto=$datos[$i];
    ...
    $lista.="<td><a href='principal.php?CONTENIDO=calidad/otro/menuProceso.php&ideProceso={$ideProceso}&CONTENIDOINTERNO=calidad/otro/{$visualizador}&ruta=/{$carpeta}/Procedimientos/{$objeto->mostrarFormato()}'><img src='../presentacion/iconos/pdf.png' height='50px' title='PDF'></a></td>";
    $lista.='</tr>';
}

?>
<div id="listados">
    <img src="../presentacion/iconos/procedimientos.png" title="Procedimientos" height="90px" style="opacity: 0.8;float: left">

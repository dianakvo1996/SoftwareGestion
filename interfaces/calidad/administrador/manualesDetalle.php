...
for ($i = 0; $i < count($datos); $i++) {
   $objeto=$datos[$i];
    ...
    $lista.="<td><a href='principal.php?CONTENIDO=calidad/administrador/menuProceso.php&ideProceso={$ideProceso}&CONTENIDOINTERNO=calidad/administrador/visualizadorPDF.php&ruta={$carpeta}/Manuales/{$objeto->getRuta()}'><img src='../presentacion/iconos/pdf.png' height='50px' title='PDF'></a></td>";
    $lista.='</tr>';
}

...
switch ($accion) {
    case 'Adicionar':       
        ...
        if ($validarUsuario->getUsuario()!=null) {
            $direccion='formularioUsuario.php&accion=Adicionar&MENSAJE=Ese nombre de usuario ya esta en uso';
        } else {
...
header("Location: ../../principal.php?CONTENIDO=calidad/administrador/$direccion");

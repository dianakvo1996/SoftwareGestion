...
$datos= EquipoC::getDatosEnObjetos("ideSede=$ideSede",null);
$lista='';
//lista meeses
...
//fin lista equipos
?>
<a href="principal.php?CONTENIDO=calibracion/administrador/equiposSede.php&ideSede=<?=$sede->getIde()?>" style="float: left"><img src="../presentacion/iconos/atras.png" title="Volver" height="20px"></a>
<div id="listados">
    <img src="../presentacion/iconos/cronogramaCalibracion.png" height="100px">
    <table style="">
        <tr>
            <th>Cliente</th><td><?=$sede->getCliente()->getNombre()?></td><th>Sede</th><td><?=$sede->getNombre()?></td>
            <th>
                <a href="calibracion/administrador/exportarCronogramaCalibracionSedeExcel.php?ideSede=<?=$ideSede?>"><img src="../presentacion/iconos/exportarExcel.png" height="30px" title="Exportar Excel"></a>
                
            </th>
        </tr>
        <tr>
            <th>Perioricidad</th><td><?=$cronograma->getPerioricidadLista()?></td>
            <th>Mes</th><td><?=$cronograma->getMesLista()?></td><td><a href="principal.php?CONTENIDO=calibracion/administrador/calibracionSedeFormulario.php&ideCronograma=<?=$cronograma->getIde()?>" class="enlace">Agregar Calibración</a></td>          
        </tr>

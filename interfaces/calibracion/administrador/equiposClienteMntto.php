...
<div id="listados">
    <table>
        ...
        <tr>
            <th>Cliente</th><td class="encabezado" colspan="4"><?=$cliente->getNombre()?></td>
        </tr>
    </table>
    <center>
    <form method="POST">
        <table>
            <tr>
                ...
                <td>
                    ...
                    <a href="principal.php?CONTENIDO=calibracion/administrador/equiposClienteMntto.php&nit=<?=$cliente->getNit()?>"><img src="../presentacion/iconos/restaurar.png"  title="Restaurar PÃ¡gina" height="20px"></a>
                </td>
            </tr>
        </table>
    </form>

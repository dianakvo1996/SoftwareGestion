...
//fin lista equipos----
?>
<a href="principal.php?CONTENIDO=mantenimiento/cliente/equiposSedeC.php&ideSede=<?=$sede->getIde()?>" style="float: left"><img src="../presentacion/iconos/atras.png" title="Volver" height="20px"></a>
<div id="listados">
    ...
    <table style="">
        <tr>
            ...
            <th>
                <a href="mantenimiento/cliente/exportarCronogramaCalibracionSedeExcel.php?ideSede=<?=$ideSede?>"><img src="../presentacion/iconos/exportarExcel.png" height="30px" title="Exportar Excel"></a>
                
            </th>
        </tr>
        <tr>
            <th>Perioricidad</th><td><?=$cronograma->getPerioricidadLista()?></td>
            <th>Mes</th><td><?=$cronograma->getMesLista()?></td><td><label style="color:#7FA1FD">Pendiente █ </label><label style="color:red">Ejecutado █</label></td>          
        </tr>

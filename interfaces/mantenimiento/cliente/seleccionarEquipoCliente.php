...
//Fin Bisqueda
$datos= Equipo::getDatosEnObjetos("nitCliente='{$cliente->getNit()}' $filtro", 'nombreEquipo');
$lista='';
        ...
        <table>
            <tr>
                ...
                <th>
                    ...
                    <a href="principal.php?CONTENIDO=mantenimiento/cliente/seleccionarEquipoCliente.php&nitCliente=<?=$cliente->getNit()?>"><img src="../presentacion/iconos/restaurar.png"  title="Restaurar Página" height="20px"></a>
                </th>
            </tr>
        </table>
    </form>    
...
function deshabilitar() {
    ...
    function confirmarSeleccion(ideEquipo) {
        if(confirm('¿Está Seguro de su Selección?')){
            location = 'principal.php?CONTENIDO=mantenimiento/cliente/solicitudCorrectivoClienteFormulario.php&ideEquipo='+ideEquipo;
        }
    }
</script>

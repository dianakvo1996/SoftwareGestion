...
//Fin Bisqueda
$datos= Equipo::getDatosEnObjetos("ideSede='{$sede->getIde()}' $filtro", 'nombreEquipo');
$lista='';
...
?>
<a href="principal.php?CONTENIDO=mantenimiento/cliente/seleccionSedeCorrectivo.php"><img src="../presentacion/iconos/atras.png" title="Volver" height="25px" style="float: left"></a>
<div id="listados">
    <form method="POST">
        <table>
	<tr>
		<th class="tituloSuperior" colspan="4">SELECCION DE EQUIPO</th>
	</tr>
            <tr>
                <th>Búsqueda</th>
                <td>
                ...
                <th>
                    ...
                    <a href="principal.php?CONTENIDO=mantenimiento/cliente/seleccionarEquipoSede.php&ideSede=<?=$sede->getIde()?>"><img src="../presentacion/iconos/restaurar.png"  title="Restaurar Página" height="20px"></a>
                </th>
            </tr>
        </table>
    </form>    
...
function deshabilitar() {
    ...
    function confirmarSeleccion(ideEquipo) {
        if(confirm('¿Está Seguro de su Selección?')){
            location = 'principal.php?CONTENIDO=mantenimiento/cliente/solicitudCorrectivoSedeFormulario.php&ideEquipo='+ideEquipo;
        }
    }
</script>

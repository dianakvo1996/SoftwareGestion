...
<a href="../../principal.php?CONTENIDO=mantenimiento/cliente/equiposHVS.php&ideSede=<?=$informacionGeneral->getIdeSede()?>"><img src="../../../presentacion/iconos/atras.png" title="Volver" height="30px" style="float: left" class="volver"></a>
<div class="opciones">
...
<section class="izquierda">
	<table class="informacionGeneral" border="1">
		<tr>
			<th colspan="2" class="titulos">INFORMACIÓN GENERAL</th>
		</tr>
		<tr>
	...
	<table class="fotografiaEquipo">
		<tr>
			<td class="subTitulos" rowspan="2">
				<center>
					<label>FOTOGRAFIA EQUIPO BIOMÉDICO</label><br>
					<img src="../../../FotografiasEquipos/<?=$tipoEquipo->getFotografia()?>" height="110px" id="imagenEquipo">
				</center>
			</td>
	...
	<table class="descripcionFunacional">
		...
		<tr>
			<td><p><?=strtoupper($tipoEquipo->getDescripcionFuncional())?></p></td>
		</tr>
	</table>
...
<table class="encabezado">
	...
	<table class="recomendacionFabricante">
		...
		<tr>
			<td><?=$tipoEquipo->getRutinaListaOrdenada()?></td>

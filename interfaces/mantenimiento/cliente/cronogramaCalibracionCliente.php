...
$datos= EquipoC::getDatosEnObjetos("nitCliente='$nitCliente'",null );
$lista='';
//lista meeses
...
<div id="listados">
    ...
    <table style="">
        <tr>
            ...
            <th>
                <a href="mantenimiento/administrador/cronogramaClienteExportarExcel.php?nit=<?=$nitCliente?>"><img src="../presentacion/iconos/exportarExcel.png" height="30px" title="Exportar Excel"></a>
                <a href="mantenimiento/administrador/cronogramaClienteExportarPDF.php?nit=<?=$nitCliente?>"><img src="../presentacion/iconos/exportarPDF.png" height="30px" title="Exportar PDF"></a>
            </th>
        </tr>
        <tr>

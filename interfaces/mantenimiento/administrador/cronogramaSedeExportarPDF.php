...
$reporte.='<th colspan="4" style="text-align: center;">'.$sede->getCliente()->getNombre().'-'.$sede->getNombre().'</th>';
...
$dompdf->stream("Cronograma Mantenimineto_".$sede->getCliente()->getNombre().'-'.$sede->getNombre().$fecha.".pdf",array('enable_remote' => true));
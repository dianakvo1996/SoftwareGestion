...
try {
    ...
    foreach ($sheet->getRowIterator(13) as $row) {
        ...
        $cadenaSQL="insert into equipo(nombreEquipo,marca,modelo,serial,activoFijo, ubicacion,ideSede)";
        $fila=0;
...
echo "<script> window.location='../../principal.php?CONTENIDO=mantenimiento/administrador/equiposSede.php&ideSede=".$ideSede."'; </script>";

...
<html>
    ...
    <body>
        <a href="../../principal.php?CONTENIDO=<?=$direccion?>" style="float: left" class="volver"><img src="../../../presentacion/iconos/atras.png" title="Volver" height="20px"></a>
        <div class="opciones">
            <a href="../../principal.php?CONTENIDO=mantenimiento/administrador/reporteMantenimientoPreventivo.php&ideMantenimiento=<?=$reportePreventivo->getIdeMantenimientoPreventivo()?>&ideEquipo=<?=$reportePreventivo->getIdeEquipo()?>&accion=Modificar&numeroReporte=<?=$reportePreventivo->getNumeroReporte()?>" class="boton">Modificar</a>
            ...
            <div class="formulario">
                ...
                <table class="tipoMantenimiento">
                    <tr>
                        ...
                        <td>
                            <ul class="botones">
                                <?=$reportePreventivo->getTipoMantenimientoReporte(null)?>
                                <li>
                ...
                <table class="tipoFalla">
                    <tr>
                        <td>
                            <ul class="botones">
                                <?=$reportePreventivo->getTipoFallaListaReporte(null)?>
                ...
                <table class="actividades">
                    <tr>
                        <td rowspan="2" style="border-bottom-left-radius: 8px;border-top-left-radius: 8px">
                            <table>
                                <tr>
                                    <td><?=$reportePreventivo->getPruebaInicialReporte(null)?></td>
                                    <td><?=$reportePreventivo->getSistemaOpticoReporte(null)?></td>
                                </tr>
                                <tr>
                                    <td><?=$reportePreventivo->getAspectoFisicoReporte(null)?></td>
                                    <td><?=$reportePreventivo->getSistemaElectromecanicoReporte(null)?></td>
                                </tr>
                                <tr>
                                    <td><?=$reportePreventivo->getCondicionAmbientalReporte(null)?></td>
                                    <td><?=$reportePreventivo->getSistemaVaporReporte(null)?></td>
                                </tr>
                                <tr>
                                    <td><?=$reportePreventivo->getSistemaElectronicoReporte(null)?></td>
                                    <td><?=$reportePreventivo->getSistemaOperativoReporte(null)?></td>
                                </tr>
                                <tr>
                                    <td><?=$reportePreventivo->getSistemaHidraulicoReporte(null)?></td>
                                    <td><?=$reportePreventivo->getLimpiezaInternaReporte(null)?></td>
                                </tr>
                                <tr>
                                    <td><?=$reportePreventivo->getSistemaNeumaticoReporte(null)?></td>
                                    <td><?=$reportePreventivo->getLimpiezaExternaReporte(null)?></td>
                                </tr>
                                <tr>
                                    <td> <?=$reportePreventivo->getSistemaMecanicoReporte(null)?></td>
                                    <td> <?=$reportePreventivo->getLubricacionPartesReporte(null)?></td>
                                </tr>
                                <tr>
                                    <td><?=$reportePreventivo->getSistemaElectricoReporte(null)?></td>
                                    <td><?=$reportePreventivo->getPruebasFuncionamientoReporte(null)?></td>
                                </tr>
                            </table>                         
                        </td>
                ...
                <table class="observaciones">
                    <tr>
                        <th><ul><li>&nbsp;&nbsp;EL EQUIPO FUNCIONA CORRECTAMENTE:</li><?=$reportePreventivo->getFuncionamientoCorrectoReporte(null)?></ul></th>
                    </tr>
                    <tr>
                        <td valign="top">
                            <p>

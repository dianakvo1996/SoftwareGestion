...
$nombreDescarga="Cronograma Mantenimiento_{$sede->getCliente()->getNombre()}_{$sede->getNombre()}_".date('Y-m-d_His');
header('Content-type: application/vnd.ms-excel;charset=iso-8859-15');
header('Content-Disposition: attachment; filename='.$nombreDescarga.'.xls');

$cronograma=new Cronograma('ideSede',$ideSede);

$datos= Equipo::getDatosEnObjetos("ideSede=$ideSede",'nombreEquipo');
$lista='';
//lista meeses
...
<table border="1">
    <tr>
        <th colspan="6" rowspan="4"><img src="file:///D:/wamp64/www/LaboratorioBiometrical/presentacion/imagenes/Biometrical_Miniatura.png" width="50px"></th>

...
?>
<a href="principal.php?CONTENIDO=mantenimiento/administrador/clientes.php"><img src="../presentacion/iconos/atras.png" title="Volver" height="20px"></a>
<div id="formulario">
    <center>
        <form method="POST" name="formulario" action="mantenimiento/administrador/clienteActualizar.php" onclick="habilitar()">        
        <table>
            <tr>
            ...
            <tr>
                <th>NIT:</th>
                <td colspan="2"><input type="text" name="nit" onchange="datosAcceso()" id="nit" value="<?=$cliente->getNit()?>" required="true"></td>
            </tr>
            <tr>
                <th>NOMBRE:</th>
            ...
            <tr>
                <th colspan="3">
					<input type="hidden" name="identificacionIC" value="<?=$persona->getIdentificacion()?>">

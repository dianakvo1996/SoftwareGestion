...
$sede=new Sede('ide', $equipo->getIdeSede());
...
<p style="font-family: Arial">
    <strong>Cliente:</strong>&nbsp;<?=$sede->getCliente()->getNombre()?>
    <strong>Sede:</strong>&nbsp;<?=$sede->getNombre()?>
</p>
<br>
...
<p style="font-family: Arial;text-align: justify"><strong>Diagnóstico:</strong> <?=$equipo->getJustificacion()?></p>

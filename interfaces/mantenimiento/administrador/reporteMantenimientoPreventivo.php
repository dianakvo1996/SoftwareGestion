...
if ($mantenimientoPreventivo->getIdeSede()!=null){
	...
	$ciudad=$mantenimientoPreventivo->getSede()->getCiudad()->getNombre(); 
}else{
	...
	$ciudad=$mantenimientoPreventivo->getCliente()->getCiudad()->getNombre();
}
if ($accion==='Modificar') {    
...
<div class="reporteMantenimiento">
    <form method="POST" action="mantenimiento/administrador/reportePreventivoActualizar.php" onsubmit="return contadorFilas()" onchange="javascript:habilitarProblemaPresentado()">
        <div class="encabezado">
            <div class="izquierda">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <input type="text" class="ciudad" name="ciudad" placeholder="CIUDAD" value="<?=$ciudad?>" required>
                        </td>
                        <td>
        ...
        <table class="datosMetrologicos">
			...
			<tr>
        		<td>1. <select name="ideUnidadMedida1"><?=UnidadMedida::getUnidadesOptions($reporteMantenimiento->getIdeUnidadMedida1())?></select></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorNominal1()?>" name="valorNominal1"></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorMedido1()?>" name="valorMedido1"></td>
        	</tr>
			<tr>
        		<td>2. <select name="ideUnidadMedida2"><?=UnidadMedida::getUnidadesOptions($reporteMantenimiento->getIdeUnidadMedida2())?></select></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorNominal2()?>" name="valorNominal2"></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorMedido2()?>" name="valorMedido2"></td>
        	</tr>
			<tr>
        		<td>3. <select name="ideUnidadMedida3"><?=UnidadMedida::getUnidadesOptions($reporteMantenimiento->getIdeUnidadMedida3())?></select></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorNominal3()?>" name="valorNominal3"></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorMedido3()?>" name="valorMedido3"></td>
        	</tr>
			<tr>
        		<td>4. <select name="ideUnidadMedida4"><?=UnidadMedida::getUnidadesOptions($reporteMantenimiento->getIdeUnidadMedida4())?></select></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorNominal4()?>" name="valorNominal4"></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorMedido4()?>" name="valorMedido4"></td>
        	</tr>
			<tr>
        		<td>5. <select name="ideUnidadMedida5"><?=UnidadMedida::getUnidadesOptions($reporteMantenimiento->getIdeUnidadMedida5())?></select></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorNominal5()?>" name="valorNominal5"></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorMedido5()?>" name="valorMedido5"></td>
        	</tr>
			<tr>
        		<td>6. <select name="ideUnidadMedida6"><?=UnidadMedida::getUnidadesOptions($reporteMantenimiento->getIdeUnidadMedida6())?></select></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorNominal6()?>" name="valorNominal6"></td>
        		<td><input type="number" step="any" value="<?=$reporteMantenimiento->getValorMedido6()?>" name="valorMedido6"></td>
        	</tr>

...
//Inicio datos repuestos
    ...
    //Fin datos repuestos
?>
<a href="principal.php?CONTENIDO=mantenimiento/administrador/mantenimientoCorrectivoCliente.php&nitCliente=<?=$equipo->getNitCliente()?>"><img src="../presentacion/iconos/atras.png" title="Volver" height="40px" style="float: left"></a>
<div class="reporteMantenimiento">
    <form method="POST" action="mantenimiento/administrador/reporteCorrectivoClienteActualizar.php" onsubmit="return contadorFilas()" onchange="javascript:habilitarProblemaPresentado()">
    ...
    <div class="titulo">REPORTE DE MANTENIMIENTO</div>
        <table class="datosCliente">
            ...
            <tr>
                ...
                <td class="bordeInferiorDerecho">&nbsp;&nbsp;<?=$equipo->getCliente()->getNombre()?></td>
            </tr>
        </table>

...
for($i = 0; $i < count($equipos); $i++){
	...
	if($ideReporte==null){
		$lista.="<td><a href='principal.php?CONTENIDO=mantenimiento/administrador/equiposMantenimientoSedePDF.php&ide={$ide}&accion=Subir&ideEq={$objeto->getIde()}#formulario' class='enlace' style='background:#C8C52B'>Subir Reporte</a></td>";
	}else{

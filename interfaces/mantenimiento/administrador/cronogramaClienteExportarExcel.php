...
$nombreDescarga="Cronograma Mantenimiento_{$cliente->getNombre()}_".date('Y-m-d_His');
...
<table border="1">
    <tr>
        <th colspan="6" rowspan="4"><img src="file:///D:/Programas/wamp64/www/LaboratorioBiometrical/presentacion/imagenes/Biometrical_Miniatura.png" width="50px"></th>
    ...
    <tr>
        ...
        <th colspan="4"><?=$cliente->getNombre()?></th>

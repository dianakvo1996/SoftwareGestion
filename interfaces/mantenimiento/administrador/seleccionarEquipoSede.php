...
//Fin Bisqueda
$datos= Equipo::getDatosEnObjetos("ideSede='{$ideSede}' $filtro", 'nombreEquipo');
$lista='';
...
?>
<a href="principal.php?CONTENIDO=mantenimiento/administrador/mantenimientoCorrectivoSede.php&ideSede=<?=$sede->getIde()?>"><img src="../presentacion/iconos/atras.png" title="Volver" height="30px" style="float: left"></a>
<div id="listados">
        ...
        <table>
            <tr>
                ...
                <th>
                    ...
                    <a href="principal.php?CONTENIDO=mantenimiento/administrador/seleccionarEquipoSede.php&ideSede=<?=$sede->getIde()?>"><img src="../presentacion/iconos/restaurar.png"  title="Restaurar Página" height="20px"></a>
                </th>
            </tr>
        </table>
    </form>    
...
function deshabilitar() {
    ...
    function confirmarSeleccion(ideEquipo) {
        if(confirm('¿Está Seguro de su Selección?')){
            location = 'principal.php?CONTENIDO=mantenimiento/administrador/reporteMantenimietoCorrectivoSede.php&ideEquipo='+ideEquipo+'&accion=Guardar';
        }
    }
</script>

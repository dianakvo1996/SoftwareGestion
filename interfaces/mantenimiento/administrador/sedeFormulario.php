...
?>
<a href="principal.php?CONTENIDO=mantenimiento/administrador/sedes.php&nit=<?=$cliente->getNit()?>"><img src="../presentacion/iconos/atras.png" title="Volver" height="20px"></a>
<div id="formulario">
    <center>
        <form method="POST" name="formulario" action="mantenimiento/administrador/sedeActualizar.php">
            <table>
                <tr>

...
$informacionExtra=new InformacionExtra('ideTipoEquipo',$tipoEquipo->getIde());
...
if ($informacionGeneral->getIdeSede()!=null){
	...
	$sede=$informacionGeneral->getSede()->getNombre();
	...
	$sede=$informacionGeneral->getCliente()->getNombre();
...
<section class="izquierda">
	...
	<table border="1" class="localizacion">
		...
		<tr>
			<th class="subTitulos">&nbsp;SEDE</th><td><?=$sede.' - '.$informacionGeneral->getUbicacion()?></td>
		</tr>
	</table>
	...
	<table border="1" class="adquisicion">
		...
		<tr>
			<th class="subTitulos">&nbsp;FABRICANTE</th><td><?=$adquisicion->getFabricante()->getNombre()?></td>
			<th class="subTitulos">&nbsp;FORMA DE ADQUISICION</th><td><?=$adquisicion->getFormaAquisicion()?></td>
		</tr>
		<tr>
			<th class="subTitulos">&nbsp;TELEFONO</th><td><?=$adquisicion->getFabricante()->getTelefono()?></td>
			<th class="subTitulos">&nbsp;COSTO DE ADQUISICION</th><td><?=$adquisicion->getCostoAdquisicionMostrar()?></td>
		</tr>
		<tr>
			<th class="subTitulos">&nbsp;DIRECCION</th><td><?=$adquisicion->getFabricante()->getDireccion()?></td>
			<th class="subTitulos">&nbsp;FECHA DE COMPRA</th><td><?=$adquisicion->getContenido($adquisicion->getFechaCompra())?></td>
		</tr>
		<tr>
			<th class="subTitulos">&nbsp;LUGAR DE ORIGEN</th><td><?=$adquisicion->getFabricante()->getLugarOrigen()?></td>
			<th class="subTitulos">&nbsp;FECHA DE INSTALACION</th><td><?=$adquisicion->getContenido($adquisicion->getFechaInstalacion())?></td>
		</tr>
		<tr>
			<th class="subTitulos">&nbsp;PROVEEDOR</th><td><?=$adquisicion->getProveedor()->getNombre()?></td>
			<th class="subTitulos">&nbsp;INICIO DE GARANTIA</th><td><?=$adquisicion->getContenido($adquisicion->getInicioGarantia())?></td>
		</tr>
		<tr>
			<th class="subTitulos">&nbsp;TELEFONO</th><td><?=$adquisicion->getProveedor()->getTelefono()?></td>
			<th class="subTitulos">&nbsp;FINALIZACION GARANTIA</th><td><?=$adquisicion->getContenido($adquisicion->getFinalizacionGarantia())?></td>
		</tr>
		<tr>
			<th class="subTitulos">&nbsp;DIRECCION</th><td><?=$adquisicion->getProveedor()->getDireccion()?></td>
			<th class="subTitulos">&nbsp;FECHA PUESTA SERVICIO</th><td><?=$adquisicion->getContenido($adquisicion->getFechaPuestaServicio())?></td>
		</tr>
		<tr>
			<th class="subTitulos">&nbsp;E-MAIL</th><td><?=$adquisicion->getProveedor()->getEmail()?></td>
...
<section class="derecha">
	<table class="apoyotecnico">
		...
		<tr>
			<th class="subTitulos">SERVICIO</th><td><?=$informacionGeneral->getAmbiente()->getUnidad()->getServicio()->getCodigo()?></td>
			<th class="subTitulos">UNIDAD</th><td><?=$informacionGeneral->getAmbiente()->getUnidad()->getCodigo()?></td>
			<th class="subTitulos">AMBIENTE</th><td><?=$informacionGeneral->getAmbiente()->getCodigo()?></td>
		</tr>
	</table>
...
<table class="encabezado">
	...
	<table class="recomendacionFabricante">
		...
		<tr>
			<td><?=$informacionExtra->getRecomendacionesFabricanteListaOrdenada()?></td>
		</tr>
	</table>
	<table class="recomendacionFabricante">
		<tr>
...
<div class="accionHV2">
	<a href="principal.php?CONTENIDO=mantenimiento/administrador/hojaDeVidaEquipoSede.php&ideEquipo=<?=$ideEquipo?>&accion=ACTUALIZAR&ideSede=<?=$informacionGeneral->getIdeSede()?>">Actualizar</a>
</div>
</section>
</div>
